...
def print_car_info():
    """
    Allows user to input desired car model and for console to return information about that car in a dictionary format with the heading row. 
    """
...
def car_sales_information():
    ...
    """
    sales_input = input('Enter T for total sales, enter L for lowest sales, enter H for highest car sales and enter A for average car sales, if you would like to display all enter ALL \n')
